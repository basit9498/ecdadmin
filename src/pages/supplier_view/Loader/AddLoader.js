...
import { supplierLoaderAdd } from '../../../store/action/supplierLoader.action'
                        ...
                        <from className='mt-4 flex justify-between flex-wrap'>
                            <div className=' w-[300px] mb-4'>
                                <input
                                    ...
                                    type='text' className='h-11 border text-sm w-full pl-2' placeholder='Full name' />
                            </div>
                            <div className=' w-[300px] mb-4'>
                                <input
                                    value={values.email}
                                    ...
                                    type='email' className='h-11 border text-sm w-full pl-2' placeholder='Enter your email' />
                            </div>
                            <div className=' w-[300px] mb-4'>
                                <input
                                    ...
                                    type='password' className='h-11 border text-sm w-full pl-2' placeholder='Password' />
                            </div>
                            <div className=' w-[300px] mb-4'>
                                <input
                                    ...
                                    type='text' className='h-11 border text-sm w-full pl-2' placeholder='Contect number' />
                            </div>
                            <div className=' w-[300px] mb-4'>
                                <input
                                    ...
                                    type='text' className='h-11 border text-sm w-full pl-2' placeholder='Address' />
                            </div>
                            <div className=' w-[300px] mb-4'>
                                <input
                                    ...
                                    type='text' className='h-11 border text-sm w-full pl-2' placeholder='Vehicle Reg.No' />
                            </div>
                            ...
                            <div className=' w-[300px] mb-4'>
                                <input
                                    ...
                                    type='text' className='h-11 border text-sm w-full pl-2' placeholder='5-KM price' />
                            </div>
                            <div className=' w-[300px] mb-4'>
                                <input
                                    ...
                                    type='text' className='h-11 border text-sm w-full pl-2' placeholder='Out of 5-KM price' />
                            </div>
